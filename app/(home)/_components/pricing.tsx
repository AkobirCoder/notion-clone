...
const cards = [
	...
	},
	{
		...
		price: '8',
		priceId: 'price_1TlqvhHx5uw4Sk7DjhEjZJqv',
	},
	{
		title: 'Business',
		...
		price: '15',
		priceId: 'price_1TlqtSHx5uw4Sk7D6ThcniVN',
	},
];
...
export const Pricing = () => {
    return (
        <div className='max-w-7xl mx-auto container'>
            ...
            <div className='mt-6'>
                <div className='lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0 space-y-8'>
                    {
